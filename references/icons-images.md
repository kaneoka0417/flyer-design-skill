...
写真が不足している場合や、カスタムイラスト・装飾素材が必要な場合に使用できるAI画像生成ツール。

### nano-banana CLI

- **コマンド**: `nano-banana "プロンプト" [オプション]`
- **モデル**: Flash（高速・低コスト、デフォルト）/ Pro（最高品質）
- **解像度**: 512, 1K, 2K, 4K
- **特徴**: スタイル転写（`-r`）、透過背景（`-t`）、コスト追跡
- **詳細**: `skills/nano-banana/SKILL.md` 参照
...
|------|----------|--------|
| チラシ全面背景 | 4K + pro | 最高品質 |
| チラシヒーロー | 2K-4K + pro | 高品質 |
| チラシ小画像 | 1K + flash | コスト重視 |
| スライド背景 | 2K + flash | 十分な品質 |
...
| **AI生成画像** | カスタム素材、不足写真の補完 | ヒーロー背景、装飾、イラスト |
